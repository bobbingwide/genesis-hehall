...
= 0.1.0 =
* Added: front-page with parallax scrolling and responsive menu [github bobbingwide genesis-hehall issues 1]
* Added: styled the header and footer more like the company letterhead [github bobbingwide genesis-hehall issues 2]
